...
public class SessionService {
    ...
    public SessionResponseDTO getFirstDesktopSession() {
        ...
        Session session = sessionRepository.getFirstDesktopSession(desktop);
    ...
    public List<SessionResponseDTO> getSessionsFromActiveUsersEndedBefore2025() {
        LocalDateTime dateLimit = LocalDateTime.of(2025, 1, 1, 0, 0);
        List<Session> sessions = sessionRepository.getSessionsFromActiveUsersEndedBefore2025(dateLimit);
